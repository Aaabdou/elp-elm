	...
	return _Utils_Tuple2(
		{
			...
			dicerr: $author$project$Main$Waiting,
			liste: _List_Nil,
			nb: 3,
			win: false,
			worderr: $author$project$Main$Loading
		},
		$author$project$Main$getNicknames);
};
...
var $author$project$Main$getWord = F2(
	function (liste, nb) {
		var _v0 = $elm$core$List$head(
			A2($elm$core$List$drop, nb, liste));
		if (_v0.$ === 'Just') {
			var y = _v0.a;
			return y;
		} else {
...
var $author$project$Main$test = function (l) {
	...
	function (msg, model) {
		switch (msg.$) {
			case 'SendHttpRequest':
				return _Utils_Tuple2(model, $author$project$Main$getNicknames);
			case 'WordsReceived':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var nicknamesStr = result.a;
					...
					return _Utils_Tuple2(
						{
							...
							nb: model.nb,
							win: false,
							worderr: $author$project$Main$Error(
			...
			case 'DataReceived':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						{
							dic: $author$project$Main$test(defs),
							dicerr: $author$project$Main$Done,
							liste: model.liste,
							nb: model.nb,
							win: false,
							worderr: $author$project$Main$Done
					...
					return _Utils_Tuple2(
						{
							dic: {meanings: _List_Nil, word: model.dic.word},
							dicerr: $author$project$Main$Error(
								$author$project$Main$buildErrorMessage(httpError)),
							liste: model.liste,
							nb: model.nb,
							win: false,
			...
			case 'Change':
				...
				return _Utils_Tuple2(
					{
						dic: {meanings: model.dic.meanings, word: model.dic.word},
						dicerr: model.dicerr,
						liste: model.liste,
						nb: model.nb,
						win: _Utils_eq(word, model.dic.word),
						worderr: model.worderr
					},
					$elm$core$Platform$Cmd$none);
			default:
			...
			switch (_v1.$) {
				...
				case 'Loading':
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('definition Loading')
							]));
				default:
					return A2(
						$elm$html$Html$li,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('defintition Waiting')
							]));
			}
		case 'Loading':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('word Loading')
					]));
		default:
			return A2(
				$elm$html$Html$li,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('word Waiting')
					]));
	}
};
